    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.card}>
                ...
                <TextInput style={styles.input} placeholder="Selário:"
                    placeholderTextColor={"#ACA3A9"}
                    onChangeText={(textSalario) => setSalario(textSalario)} secureTextEntry />
...
export default CadastroScreenProfissional;